    ...
    for (var i = 0; i < message_tokens.length; i++) {
        ...
        switch (message_token.type) {
            case "mention":
                ...
                if ( i === 0 || (i === 1 && /^\s+$/.test( message_tokens[0].token )) ) {
                    this.replies.push( username );
                }
                this.html += "@<a class=\"tweet-url username\" href=\"http://twitter.com/" + username + "\">" + username + "</a>";
                break;
            case "url":
            ...
            case "hashtag":
                ...
                this.html += "<a href=\"http://twitter.com/search?q=" + encodeURIComponent(hashtag) + "\" title=\"" + hashtag + "\" class=\"tweet-url hashtag\">" + hashtag + "</a>";
                break;
            default:
